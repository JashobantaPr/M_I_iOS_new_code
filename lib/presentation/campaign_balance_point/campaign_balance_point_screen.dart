...
class CampaignBalancePointsScreen
    extends GetWidget<CampaignBalancePointsController> {
  const CampaignBalancePointsScreen({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Balance Point: ${controller.balancepoints ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
                                ...
                                children: [
                                  ...
                                  _buildDataRow(
                                      ...
                                      transaction.expirePoints != null
                                          ? transaction.expirePoints.toString()
                                          : '0'),
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    transaction.debitPoints != null
                                        ? transaction.debitPoints.toString()
                                        : '0',
                                    style: TextStyle(
                                      fontSize: 16.sp,
                                      fontWeight: FontWeight.bold,
    ...
    return Obx(() {
      return CustomDropdown<String?>(
        ...
        onChanged: (String? value) {
          controller.campaignsValue.value = value;
        },
        value: controller.campaignsValue.value,
