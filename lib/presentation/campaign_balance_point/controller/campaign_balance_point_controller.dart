...
import 'package:incentivesgit/presentation/campaign_balance_point/service/balance_point_service.dart';
...
class CampaignBalancePointsController extends GetxController {
  ...
  void transactionhistory(int? selectedYear, String? selectedCampaign) async {
    ...
    try {
      ...
      if (selectedYear != null) {
        result = await BalancePointsService().transactiondata(selectedYear);
      } else {
        result = await BalancePointsService().allTransactions();
      }
