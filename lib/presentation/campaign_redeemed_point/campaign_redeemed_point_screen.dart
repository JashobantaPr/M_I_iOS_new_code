...
class CampaignRedeemedPointsScreen
    extends GetWidget<CampaignRedeemedPointsController> {
  const CampaignRedeemedPointsScreen({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Redeemed Point: ${controller.redeemedpoints ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      Get.toNamed(
                                        ...
                                        arguments:
                                            transaction.transactionHeaderIdPk,
                                      );
                                    },
                                    child: Text(
                                      'View Details',
