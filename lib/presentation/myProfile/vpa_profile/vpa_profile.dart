...
class VpaProfileScreen extends GetWidget<VpaProfileController> {
  const VpaProfileScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final VpaProfileController controller = Get.put(VpaProfileController());
  ...
  Widget _profileData(BuildContext context) {
    return Obx(() {
      final vpaDetails = controller.vpaData.value.vpaDetails;
      print('fgfdghghfdh$vpaDetails');
      ...
      return Column(
        ...
        children: [
          ...
          _profileType(vpaDetails.vpaLinkedMobile),
          SizedBox(height: 10.h),
          _cardNumber(vpaDetails.vpaAccount, vpaDetails.approvalStatusId),
          SizedBox(height: 10.h),
          _cardName(vpaDetails.vpaWalletName),
          SizedBox(height: 10.h),
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(
                  text: '${controller.vpaData.value.vpaDetails.approvalStatus}',
  ...
  Widget _profileType(String vpaLinkedMobile) {
  ...
  Widget _cardNumber(String vpaAccount, String approvalStatusId) {
    return Container(
      height: 60.h,
      padding: EdgeInsets.symmetric(horizontal: 17.w),
      decoration: BoxDecoration(
  ...
  Widget _cardName(String vpaWalletName) {
    return GestureDetector(
      onTap: () {},
      child: Container(
        height: 60.h,
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text:
                              ' ${controller.vpaData.value.vpaDetails?.approvalStatus}',
                          style: const TextStyle(
                            fontWeight: FontWeight.bold,
                          ),
                        ),
            ...
            CustomTextField(
              ...
              hintText: '${controller.decryptedAccountNAme}',
            ),
            Obx(() {
            ...
            //             hintText:
            //                 controller.vpaData.value.panDetails?.panCardImage ??
            //                     'No file chosen',
  ...
  //           controller.vpaData.value.vpaWallets?.length ?? 0,
  //           (index) {
  //             var profileType = controller.vpaData.value.vpaWallets?[index];
