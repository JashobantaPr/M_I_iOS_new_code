...
class CampaignExpiredPointsScreen
    extends GetWidget<CampaignExpiredPointsController> {
  const CampaignExpiredPointsScreen({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Expired Point: ${controller.expiredpoints ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
