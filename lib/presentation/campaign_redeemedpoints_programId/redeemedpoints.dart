...
class CampaignRedeemedPointsScreen1
    extends GetWidget<CampaignRedemeedePointsController1> {
  const CampaignRedeemedPointsScreen1({super.key});
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.w),
                    Text(
                      'Total Redeemed Points: ${Get.arguments[0]['calculatedpayout'] ?? '0'}',
                      style: TextStyle(
                          fontSize: 16.sp,
                ...
                Obx(() {
                  ...
                  if (controller.transactions.isEmpty) {
                    return const Center(child: Text('No redeemed points'));
                  }
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    '${controller.transactions[index].debit}',
                                    style: TextStyle(
                                      fontSize: 16.sp,
                                      fontWeight: FontWeight.bold,
    ...
    return Obx(() {
      return CustomDropdown<String?>(
        ...
        onChanged: (String? value) {
          ...
          print('kdsfhf ${controller.yearValue.value}');
        },
