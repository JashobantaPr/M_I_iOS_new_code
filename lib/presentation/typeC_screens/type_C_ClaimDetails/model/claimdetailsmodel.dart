...
class ResponseData {
  ...
  factory ResponseData.fromJson(Map<String, dynamic> json) {
    return ResponseData(
      ...
      claimCustomFields: _parseCustomFields(json['claim_custom_feilds_json']),
  ...
  static List<CustomField>? _parseCustomFields(String? jsonString) {
    if (jsonString == null) return null;
    try {
      List<dynamic> parsedJson = jsonDecode(jsonString);
      return parsedJson.map((e) => CustomField.fromJson(e)).toList();
    } catch (e) {
      print('Error parsing claim_custom_feilds_json: $e');
      return null;
    }
  }
}
